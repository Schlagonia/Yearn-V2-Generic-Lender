...
@pytest.fixture
def plugin(strategist, GenericIronBank, strategy):
    plugin = strategist.deploy(GenericIronBank, strategy, "IronBankPlugin")
...
def pluginUsdc(
    ...
    pluginUsdc = strategist.deploy(GenericIronBank, strategyUsdc, "IronBankPlugin")
...
@pytest.fixture
def pluggedStrategy(strategy, plugin, gov):
...
@pytest.fixture
def pluggedStrategyUsdc(strategyUsdc, pluginUsdc, gov):
