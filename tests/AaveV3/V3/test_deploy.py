...
def test_deploy(
    strategist, strategy, GenericAaveV3, wftm, aWftm, lendingPool, router, router2
):
    incentivize = False

    v3Plugin = strategist.deploy(
        GenericAaveV3, strategy, wftm.address, router, router2, "AaveV3", incentivize
    )
...
def test_deploy_incentivized(
    strategist, strategy, GenericAaveV3, wftm, aWftm, router, router2, lendingPool
):
    incentivize = True
...
def test_reinitialize(v3Plugin, wftm, router, router2):
