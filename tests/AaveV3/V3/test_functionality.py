...
# Set is Incentivised
def test_set_incentivized(v3Plugin, gov, rando):
...
# set referral code
def test_referral_code(v3Plugin, gov, rando):
...
# set keeper
def test_set_keeper(v3Plugin, gov, keeper, rando):
...
def test_change_router(v3Plugin, gov, rando, router, router2):
